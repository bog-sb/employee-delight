...
INSERT INTO `product_categories` VALUES (1,'Fruit'),(2,'Drinks'),(3,'Snacks');
...
INSERT INTO `products` VALUES (1,'Cola',7,'',2),(2,'Sprite',7,'',2),(3,'Apples',4,'',1),(4,'Bananas',5,'',1),(5,'Oranges',5,'',1);
...
CREATE TABLE `users` (
  ...
  KEY `group_user_fk_idx` (`fk_group`),
  CONSTRAINT `group_user_fk` FOREIGN KEY (`fk_group`) REFERENCES `user_groups` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `users` VALUES (1,'user','pass','user@domain.com','gica',1,'\0','123',0),(2,'admin','pass','admin@domain.com','boss',1,'','123',83);
...
INSERT INTO `votes` VALUES (1,1,1,5,NULL,'\0'),(2,1,2,9,NULL,'\0'),(3,2,1,6,NULL,'\0'),(4,2,4,10,NULL,'\0'),(5,2,3,1,'2014-04-13','\0'),(6,2,3,2,'2014-04-13','\0'),(7,2,4,5,'2014-04-13','\0'),(8,2,1,12,'2014-04-13','\0'),(9,2,4,5,'2014-04-13','\0');
...
-- Dump completed on 2014-04-13  5:18:08
